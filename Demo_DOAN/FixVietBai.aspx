<%@ Page Title="" Language="C#" MasterPageFile="~/TacGia.Master" AutoEventWireup="true" CodeBehind="FixVietBai.aspx.cs" Inherits="Demo_DOAN.FixVietBai" %>
...
<style>
    ...
    <div class="noidung">
        ...
        <div class="bt-container">
            <asp:Button ID="btndang" runat="server" CssClass="bt" Text="Cập Nhật" OnClick="btndang_Click" />
        </div>
        <br />
        <br />
    </div>
