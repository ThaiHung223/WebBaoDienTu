<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="DefaultAd.aspx.cs" Inherits="Demo_DOAN.DefaultAd" %>
        ...
        <div class="wp_content">
            ...
            <div class="content">
                <table>
                    <tr>
                        <td class="cot">
                            <b style="font-size: 20px; font-family: Arial;">BÀI BÁO CHỜ DUYỆT :</b>
                            <asp:DataList ID="dl_baodt" runat="server" RepeatColumns="3" OnItemCommand="dl_baodt_ItemCommand">
                                <ItemTemplate>
                                    <div class="item_template">
                                        ...
                                        <br />
                                        <div class="button-container"><asp:Label ID="Label" runat="server" Text='<%# Eval("TRANGTHAI") %>' CssClass="text-capitalize" Style="font-size: 18px; color: red; font-weight: bold;"></asp:Label>     
                                            <br /><br />
                                            <asp:Button ID="btnpheduyet" runat="server" Text="Phê Duyệt" CssClass="bt2" CommandArgument='<%# Eval("MABAO") %>' Visible='<%# Eval("TRANGTHAI").ToString() != "Đã duyệt" %>' OnClick="btnpheduyet_Click" />
                                        <asp:Button ID="btnxoa" runat="server" Text="Xóa" CssClass="bt2" CommandName="Delete" CommandArgument='<%# Eval("MABAO") %>' />
                                        </div>
                                    </div>
                                </ItemTemplate>
                            </asp:DataList>
